...
export default async function youtubeSearch(query) {
    ...
    for (const value of contents) {
        ...
        if (isChannel) {
            ...
            // idk?
            const subscriberH = (((_y = result.videoCountText.accessibility) === null || _y === void 0 ? void 0 : _y.accessibilityData.label)
                || result.videoCountText.simpleText).trim();
            const channelName = result.title.simpleText
                || ((_z = result.shortBylineText.runs.find((run) => 'text' in run && typeof run.text === 'string')) === null || _z === void 0 ? void 0 : _z.text);
            ...
            const subscriber = subscriberH.split(' ')
                ...
                .join(' ');
            const isVerified = ((_0 = result.ownerBadges.find((badge) => 'metadataBadgeRenderer' in badge && badge.metadataBadgeRenderer && typeof badge.metadataBadgeRenderer === 'object')) === null || _0 === void 0 ? void 0 : _0.metadataBadgeRenderer.style) === 'BADGE_STYLE_TYPE_VERIFIED'
                || false;
